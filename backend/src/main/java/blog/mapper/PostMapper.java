...
public class PostMapper {
   ...
   * @param p The Post entity to map
   * @param mediaRepo The MediaRepository to fetch avatar media URL
   * @return PostSummaryDto instance with avatarUrl
   */
  public static PostSummaryDto toSummary(Post p, MediaRepository mediaRepo) {
